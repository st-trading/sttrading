          ...
          <nav className="hidden md:flex space-x-8">
            {navItems.map((item) => (
              <div key={item.id} className="relative group">
                ...
                {item.subItems && (
                  <div className="absolute left-1/2 -translate-x-1/2 mt-2 w-48 rounded-xl bg-slate-800 border border-slate-700 shadow-xl opacity-0 translate-y-2 pointer-events-none group-hover:opacity-100 group-hover:translate-y-0 group-hover:pointer-events-auto transition-all duration-200">
